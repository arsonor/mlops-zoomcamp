...
The goal of this homework is to create a simple training pipeline, use mlflow to track experiments and register best model, but use Prefect for orchestration.
...
2.20.19 (pip install "prefect<3.0.0")
